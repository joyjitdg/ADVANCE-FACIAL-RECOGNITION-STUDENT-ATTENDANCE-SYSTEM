...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"Images_GUI\loginBg.jpg")
    ...
    def reset_pass(self):
        if self.var_ssq.get()=="Select":
            ...
            if row==None:
                ...
                value=(self.var_pwd.get(),self.txtuser.get())  #user =email
                mycursor.execute(query,value)
...
#new data train
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"Images_GUI\photo.png")
        ...
        pho_b1_1 = Button(bg_img,command=self.open_img,text="Photo",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
