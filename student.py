...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","Computer","BCA","IT","Civil","Mechanical")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","CSE","BCA","IT","CE","ME")
        cou_combo.current(0)
        ...
        div_combo["values"]=("Select Division","1-25","26-47")
        div_combo.current(0)
        ...
        #Phone Number
        student_mob_label = Label(class_Student_frame,text="Mobile No:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
